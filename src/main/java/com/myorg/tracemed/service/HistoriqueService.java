...
public class HistoriqueService {
    ...
    public ColisHistoriqueDto getHistorique(String identifiantColis) {
        ...
        List<EvenementDto> eventDtos = events.stream().map(ev -> {
            ...
            try {
                java.lang.reflect.Method m = ev.getClass().getMethod("getDateCreation");
            ...
            return EvenementDto.builder()
                    ...
                    .realiseParOrganisation(ev.getRealiseParOrganisation() == null ? null : ev.getRealiseParOrganisation().getNom())
        ...
        return ColisHistoriqueDto.builder()
                ...
                .statut(statutStr)
                .proprietaireActuelId(colis.getProprietaireActuel() == null ? null : colis.getProprietaireActuel().getId())
                .proprietaireActuelNom(colis.getProprietaireActuel() == null ? null : colis.getProprietaireActuel().getNom())
